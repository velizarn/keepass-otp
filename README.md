...
>
> Storing both your password and your OTP (TOTP) seed in the same KeePass database violates the core principle of Two-Factor Authentication (2FA) - which requires **something you know** (password) plus **something you have** (OTP device).
> 
> Compromise of the database compromises both factors simultaneously.<br />
> Do not use this single-vault configuration for production or high-security accounts.
...
- [KeePass with YubiKey](https://www.yubico.com/works-with-yubikey/catalog/keepass/)
